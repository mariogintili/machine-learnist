...
- Problem solving, reasoning and learning are hard. But explanations/justifications are even harder: for me this is the biggest conundrum, it would be an awesome thing to plot a model that could easily then show you how to make the best decision.
